...
Documents are stored in **Vercel Blob**, private, as fixed by `docs/architecture.md §6`.
This workflow does not choose the storage system; it requires only a stable reference to a
private object.
